...
impl Theme {
    ...
    pub fn default_dark() -> Self {
        Self {
            ...
            type_: Color::Rgb { r: 78, g: 201, b: 176 },         // Teal/green (for classes and imports)
            ...
            variable: Color::Rgb { r: 156, g: 220, b: 254 },     // Light blue (all variables including 'self')
            constant: Color::Rgb { r: 79, g: 193, b: 255 },      // Bright blue (True, False, None)
            parameter: Color::Rgb { r: 156, g: 220, b: 254 },    // Light blue (function parameters)
            property: Color::Rgb { r: 156, g: 220, b: 254 },     // Light blue (e.g., self.attribute)
